 ...
 */
package lk.ijse.drivingschool.alerts;
...
import lk.ijse.drivingschool.resources.Constants;
...
public class AlertsBuilder {
    ...
    public static void create(AlertType type, AnchorPane dialogContainer, Node nodeToBlur, Node nodeToDisable, String body) {
        setFunction(type);
